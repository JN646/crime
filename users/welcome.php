...
if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) {
  ...
  if (isset($_SESSION["id"])) {
    $userid = $_SESSION["id"]; // If there is a session ID.
  }
}
?>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                   ...
                   <tr>
                     ...
                     <td class='text-center'>
                       <a href="crimemanager.php?edit=<?php echo $row['report_id']; ?>" data-toggle="" data-target="" class="btn btn-link"><i class="far fa-edit"></i></a>
                     </td>
                     <td class='text-center'>
                       <a href="lib/crimeserver.php?del=<?php echo $row['report_id']; ?>" class="btn btn-link"><i class="far fa-trash-alt"></i></a>
                     </td>
                   </tr>
                   <?php
                }
